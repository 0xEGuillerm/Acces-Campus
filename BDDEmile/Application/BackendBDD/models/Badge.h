...
class Badge
{
  public:
     ...
     */
    explicit Badge(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Badge(const Json::Value &pJson) noexcept(false);
     ...
     */
    Badge(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Badge>;
    friend drogon::orm::BaseBuilder<Badge, true, true>;
    friend drogon::orm::BaseBuilder<Badge, true, false>;
    friend drogon::orm::BaseBuilder<Badge, false, true>;
    friend drogon::orm::BaseBuilder<Badge, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Badge>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where uuid_badge = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where uuid_badge = $1";
        return sql;
    }
