...
public:
    ...
    static drogon::Task<drogon::HttpResponsePtr> SalleCrenauxPSWController(
        drogon::HttpRequestPtr req);
    /*
    drogon::Task<drogon::HttpResponsePtr> ReserverSallePSWController(
        drogon::HttpRequestPtr req);
        */
    static drogon::Task<drogon::HttpResponsePtr> PlanningSallePSWController(
        drogon::HttpRequestPtr req);
    static drogon::Task<drogon::HttpResponsePtr> EtatSallePSWController(
        drogon::HttpRequestPtr req);
    static drogon::Task<drogon::HttpResponsePtr> LoginPSWController(
        drogon::HttpRequestPtr req);
